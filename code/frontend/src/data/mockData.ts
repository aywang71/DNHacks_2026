...
export const vessels: Vessel[] = [
  {
    id: 'ocean-star', name: 'Ocean Star', imo: 'IMO 9412387', flag: 'Panama', vesselType: 'Crude oil tanker', riskScore: 82, riskLevel: 'high', eventKind: 'dark-period', eventLabel: 'AIS dark period', location: 'Eastern Mediterranean', lastSeen: '31h ago',
    evidence: [
  ...
  {
    id: 'mare-azur', name: 'Mare Azur', imo: 'IMO 9317024', flag: 'Liberia', vesselType: 'Product tanker', riskScore: 74, riskLevel: 'review', eventKind: 'encounter', eventLabel: 'Vessel encounter', location: 'Gulf of Guinea', lastSeen: '4h ago',
  ...
  {
    id: 'northwind', name: 'Northwind', imo: 'IMO 9581340', flag: 'Malta', vesselType: 'Bulk carrier', riskScore: 66, riskLevel: 'watch', eventKind: 'loitering', eventLabel: 'Unusual loitering', location: 'South Atlantic', lastSeen: '7h ago',
