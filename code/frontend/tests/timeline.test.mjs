...
import { HOUR, DAY, dateRange, presetStart, coveredHours, earliestPositionedHour, latestPositionedHour, nextCovered, requiredDays, currentObservations, interpolateObservations, trailFeatures, directionFeature, mergeVessels, createLatestRequest } from '../src/presence/timeline.mjs'
